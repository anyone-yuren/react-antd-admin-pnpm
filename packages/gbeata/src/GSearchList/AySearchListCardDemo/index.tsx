          ...
          return (
            <List.Item key={record.sort_id}>
              <Card
                ...
                actions={[
                  <GAction type="text" sub record={record} action="view">
                    详情
                  </GAction>,
                  <GAction type="text" sub record={record} action="update">
                    编辑
                  </GAction>,
                  <GAction type="text" sub record={record} action="delete">
                    删除
                  </GAction>,
                ]}
              >
                <div style={{ padding: 16, display: 'flex' }}>
                  <img
                    src={record.half?.replace('110', '170')}
                    width={100}
                    height={200}
                  />
