...
import { MwSearchList, MwAction, MwCtrl, MwSearchTableField, MwTableCtrlField, AnyKeyProps } from 'multiway'
          ...
          return (
            <List.Item key={record.sort_id}>
              <Card
                ...
                actions={[
                  <MwAction type="text" sub record={record} action="view">
                    详情
                  </MwAction>,
                  <MwAction type="text" sub record={record} action="update">
                    编辑
                  </MwAction>,
                  <MwAction type="text" sub record={record} action="delete">
                    删除
                  </MwAction>
                ]}
              >
