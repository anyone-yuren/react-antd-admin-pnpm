...
export default function useSelection(_props: UseSelectionProps): UseSelectionReturns {
  ...
  const message = (
    <div>
      ...
      <MwAction className="ml" type="link" size="small" onClick={clearSelection}>
  ...
  /** 头部已选中的提示 */
  const header = selectionKeys.length ? <Alert className="mw-search-table-alert" message={message} showIcon /> : ''
