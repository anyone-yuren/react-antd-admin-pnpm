...
import { RenderProps } from './mw-table'
...
export const install = (registerTableRender: (key: string, render: (props: RenderProps) => ReactNode) => void) => {
  ...
  registerTableRender('editable-cell-input', ({ text, field }: RenderProps): any => {
  ...
  registerTableRender('editable-cell-select', ({ text, field }: RenderProps): any => {
