...
import MwTagGroup from '../MwTagGroup'
import MwCardGroup from '../MwCardGroup'
import { AnyKeyProps } from '../types/AnyKeyProps'
import { RegisterFieldProps } from './mw-form'
...
export const install = (registerField: (fieldType: string, field: RegisterFieldProps) => void) => {
  ...
  registerField(FORM_TYPE_INPUT, {
    ...
    render: ({ field, readonly, getFieldValue }: AnyKeyProps) => {
      return readonly ? (
        <span className="mw-form-text">{getFieldValue(field.key) || FORM_READONLY_EMPTY}</span>
      ) : (
        <Input
  ...
  registerField(FORM_TYPE_SELECT, {
    ...
    render: ({ field, readonly, getFieldValue }: AnyKeyProps) => {
      if (readonly) {
        ...
        return <span className="mw-form-text">{text || FORM_READONLY_EMPTY}</span>
      }
  ...
  registerField(FORM_TYPE_TAG_GROUP, {
    ...
    render: ({ field, readonly }: AnyKeyProps) => (
      <MwTagGroup readonly={readonly} options={field.options} {...field.props} />
    )
  })
  ...
  registerField(FORM_TYPE_CARD_GROUP, {
    ...
    render: ({ field, readonly }: AnyKeyProps) => (
      <MwCardGroup readonly={readonly} options={field.options} {...field.props} />
    )
  })
