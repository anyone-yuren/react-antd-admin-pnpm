...
import { MwFormField } from './mw-form'
 ...
 * @returns 新的配置项
 */
export default function parseFields(fields: Array<MwFormField>, formatValues: FormValues) {
  const loop = (field: MwFormField) => {
    let newField = field
 ...
 * @returns
 */
export const getDateValue = (value: any, field: MwFormField, readonly?: boolean) => {
  // 获得格式化日期格式
