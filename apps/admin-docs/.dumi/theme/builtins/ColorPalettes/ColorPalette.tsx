  ...
  const colorValue = useMemo(() => {
    ...
    switch (mode) {
      ...
      case 'oklch':
        ...
        return `${safeFixed(light * 100)},${safeFixed(ch * 100)},${safeFixed(
          hue,
        )}`;
      ...
      case 'hsl':
        ...
        return `${safeFixed(hsl[0])},${safeFixed(hsl[1] * 100)}%,${safeFixed(
          hsl[2] * 100,
        )}%`;
      ...
      case 'hsv':
        ...
        return `${safeFixed(hsv[0])},${safeFixed(hsv[1] * 100)}%,${safeFixed(
          hsv[2] * 100,
        )}%`;
    }
  }, [mode, color]);
